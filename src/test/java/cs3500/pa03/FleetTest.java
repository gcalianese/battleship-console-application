...
public class FleetTest {
  ...
  public void testSetUp() {
    ...
    testFleet = new Fleet(new AiPlayer(), testList);
  }
  ...
  public void testGetFleet() {
    ...
    Fleet testFleet2 = new Fleet(new AiPlayer(), new ArrayList<>());
  ...
  public void testDetermineNumShots() {
    Shots s = new Shots(new AiPlayer());
    Board b = new Board(2, 2, new AiPlayer());
