...
public class BoardTest {
  ...
  private List<Coord> placement1;
  private List<Coord> placement2;
  ...
  @BeforeEach
  public void setUp() {
    board1 = new Board(6, 6, new AiPlayer());
    board2 = new Board(7, 9, new AiPlayer());
    board3 = new Board(3, 3, new AiPlayer());

    placement1 = new ArrayList<>();
    placement2 = new ArrayList<>(Arrays.asList(new Coord(0, 1),
  ...
  public void testUpdateBoard() {
    ...
    Fleet f = new Fleet(new AiPlayer(), testFleet);
    Shots testShots = new Shots(new AiPlayer());
