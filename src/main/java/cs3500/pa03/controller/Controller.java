...
public class Controller {
  ...
  public Controller(Scanner s) {
    ...
    ai = new AiPlayer();
    userShots = new Shots(user);
    aiShots = new Shots(ai);
    userFleet = new Fleet(user, new ArrayList<>());
    aiFleet = new Fleet(user, new ArrayList<>());
  }
  ...
  public int getSetupInfo(Scanner s) {
    ...
    userFleet = new Fleet(user, user.setup(height, width, fleet));
    aiFleet = new Fleet(ai, ai.setup(height, width, fleet));
    userBoard = new Board(height, width, user);
    aiBoard = new Board(height, width, ai);
    return max;
  }
  ...
  public List<Coord> getAiShotInfo() {
    ...
    if (!validShots(nextRound, aiShots, aiBoard)) {
      return getAiShotInfo();
    }
